  ...
  <div className="space-y-4">
    <div className="flex items-start space-x-4">
      ...
      <div>
        ...
        <a href="m.gunamurugan2004@gmail.com" className="text-purple-100 hover:text-white transition-colors">m.gunamurugan2004@gmail.com</a>
      </div>
    </div>
    ...
    <div className="flex items-start space-x-4">
      ...
      <div>
        ...
        <p className="text-purple-100">Trichy, India</p>
      </div>
    </div>
    ...
    <div className="pt-6">
      ...
      <div className="flex space-x-4">
        <a href="https://github.com/Kirisos-Guna" target="_blank" rel="noopener noreferrer" className="text-purple-300 hover:text-white transition-colors">
        ...
        <a href="https://www.linkedin.com/in/kirisos-guna/" target="_blank" rel="noopener noreferrer" className="text-purple-300 hover:text-white transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
